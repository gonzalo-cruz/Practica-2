...
Utilizamos la prueba de chi-cuadrado de bondad de ajuste, ya que nos permite comparar una distribución observada con la distribución teórica esperada.

```{r}
# Frecuencias observadas
observed <- c(2, 4, 4, 5, 2)

# Distribución uniforme
expected <- rep(50/5, 5)
# Realizar la prueba chi-cuadrado
chi2_test <- chisq.test(observed, p = rep(1/5, 5))
